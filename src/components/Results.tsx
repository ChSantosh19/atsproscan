      ...
      <div className="p-6 md:p-8 space-y-6">
        <div>
          ...
          <div className="bg-secondary/50 dark:bg-secondary/30 backdrop-blur-sm rounded-lg p-4 space-y-4 animate-fade-in delay-100">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4" ref={chartRef}>
        ...
        <div>
          ...
          <div className="bg-secondary/50 dark:bg-secondary/30 backdrop-blur-sm rounded-lg p-4 chart-container">
        ...
        <Button variant="default" className="w-full gap-2 animate-slide-up transition-all hover:scale-105 mt-6" onClick={onReset}>
